...
class Boat:
    ...
    def plot_boat(self):
        ...
        plt.plot(self.true_x, self.true_y, marker=boat_marker,
            markersize=10, color='blue',  markerfacecolor='none',
            linestyle = 'None', label='Boat position')
        if self.estimate_x is not None:
            plt.plot(self.estimate_x, self.estimate_y, marker=boat_marker,
                markersize=10, color='red', markerfacecolor='none',
...
if __name__ == "__main__":
    ...
    estimate = compute_position_3lop(boat,mark1,mark2,mark3)
